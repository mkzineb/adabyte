...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_adabyte" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ccf341a5#;
   pragma Export (C, u00001, "adabyteB");
   ...
   u00133 : constant Version_32 := 16#fa776a1d#;
   pragma Export (C, u00133, "instancesB");
   u00134 : constant Version_32 := 16#8c6390da#;
   pragma Export (C, u00134, "instancesS");
   u00135 : constant Version_32 := 16#e652c197#;
   pragma Export (C, u00135, "system__return_stackS");
   u00136 : constant Version_32 := 16#28888d98#;
   pragma Export (C, u00136, "system__finalization_mastersB");
   u00137 : constant Version_32 := 16#02e4eddb#;
   ...
   u00139 : constant Version_32 := 16#bf8c6aef#;
   pragma Export (C, u00139, "system__storage_poolsS");
   u00140 : constant Version_32 := 16#7c78c3c5#;
   pragma Export (C, u00140, "system__pool_globalB");
   u00141 : constant Version_32 := 16#91b367a5#;
   ...
   u00144 : constant Version_32 := 16#8c10043a#;
   pragma Export (C, u00144, "typesS");
   u00145 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00145, "ada__containers__helpersB");
   u00146 : constant Version_32 := 16#444c93c2#;
   ...
   u00148 : constant Version_32 := 16#9e75407b#;
   ...
   u00151 : constant Version_32 := 16#f1d549fe#;
   ...
   u00153 : constant Version_32 := 16#a291ec84#;
   ...
   u00156 : constant Version_32 := 16#e7771600#;
   pragma Export (C, u00156, "system__powten_fltS");
   u00157 : constant Version_32 := 16#2a9b675e#;
   pragma Export (C, u00157, "system__img_lfltS");
   u00158 : constant Version_32 := 16#585f81ee#;
   pragma Export (C, u00158, "system__img_lluS");
   u00159 : constant Version_32 := 16#ad0ace1a#;
   pragma Export (C, u00159, "system__wid_lluS");
   u00160 : constant Version_32 := 16#ee65fd70#;
   pragma Export (C, u00160, "system__powten_lfltS");
   u00161 : constant Version_32 := 16#b49a0e5d#;
   pragma Export (C, u00161, "system__storage_pools__subpoolsB");
   u00162 : constant Version_32 := 16#a2d8d50c#;
   pragma Export (C, u00162, "system__storage_pools__subpoolsS");
   u00163 : constant Version_32 := 16#b0df1928#;
   pragma Export (C, u00163, "system__storage_pools__subpools__finalizationB");
   u00164 : constant Version_32 := 16#562129f7#;
   ...
   u00166 : constant Version_32 := 16#5e0388d4#;
   pragma Export (C, u00166, "system__stream_attributesS");
   u00167 : constant Version_32 := 16#3aecdcda#;
   ...
   u00170 : constant Version_32 := 16#e58096ad#;
   pragma Export (C, u00170, "valuesS");
   u00171 : constant Version_32 := 16#d4c0c09c#;
   pragma Export (C, u00171, "ada__wide_charactersS");
   u00172 : constant Version_32 := 16#bc80e83e#;
   pragma Export (C, u00172, "instructionsB");
   u00173 : constant Version_32 := 16#59e6f61f#;
   pragma Export (C, u00173, "instructionsS");
   u00174 : constant Version_32 := 16#dcd284ef#;
   pragma Export (C, u00174, "interpreterB");
   u00175 : constant Version_32 := 16#29d684e7#;
   pragma Export (C, u00175, "interpreterS");
   u00176 : constant Version_32 := 16#e3ec85fd#;
   pragma Export (C, u00176, "ada__containers__hash_tablesS");
   u00177 : constant Version_32 := 16#eab0e571#;
   pragma Export (C, u00177, "ada__containers__prime_numbersB");
   u00178 : constant Version_32 := 16#45c4b2d1#;
   pragma Export (C, u00178, "ada__containers__prime_numbersS");
   u00179 : constant Version_32 := 16#1084670a#;
   pragma Export (C, u00179, "stackB");
   u00180 : constant Version_32 := 16#1ee1c538#;
   pragma Export (C, u00180, "stackS");
   u00181 : constant Version_32 := 16#bd5bde88#;
   pragma Export (C, u00181, "wasmS");
   u00182 : constant Version_32 := 16#6a1e742d#;
   pragma Export (C, u00182, "moduleB");
   u00183 : constant Version_32 := 16#d17a437c#;
   pragma Export (C, u00183, "moduleS");
   u00184 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00184, "gnatS");
   u00185 : constant Version_32 := 16#1a69b526#;
   pragma Export (C, u00185, "gnat__os_libS");
   u00186 : constant Version_32 := 16#696d3985#;
   pragma Export (C, u00186, "parserB");
   u00187 : constant Version_32 := 16#10f9c310#;
   pragma Export (C, u00187, "parserS");
